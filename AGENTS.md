...
- **Mockups before big UI changes** — create HTML mockup in `.Codex/` and `open` it for review
- **Commit after each feature** — atomic commits, clear messages, `Co-Authored-By: Codex`
